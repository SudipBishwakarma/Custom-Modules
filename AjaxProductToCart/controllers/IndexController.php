 ...
 *
 * @category    Pebble
 * @package     Pebble_AjaxProductToCart
 */
require_once 'Mage/Checkout/controllers/CartController.php';
class Pebble_AjaxProductToCart_IndexController extends Mage_Checkout_CartController {
    ...
    public function addAction()
    {
        ...
        if($params['isAjax'] == 1){
            ...
            try {
                ...
                if (!$cart->getQuote()->getHasError()){
                    ...
                    $response['referrer_url'] = $this->_getRefererUrl();
        ...
        $this->setRedirectUrl($this->_getRefererUrl());
    }
    ...
    public function compareAction(){
        ...
        if ($productId && (Mage::getSingleton('log/visitor')->getId() || Mage::getSingleton('customer/session')->isLoggedIn())) {
            ...
            if ($product->getId()/* && !$product->isSuper()*/) {
                ...
                $sidebar = $sidebar_block->toHtml();
                $response['sidebar'] = $sidebar;
                $response['compareCount'] = Mage::helper('catalog/product_compare')->getItemCount();
            }
        }
        $this->getResponse()->setBody(Mage::helper('core')->jsonEncode($response));
        return;
